defmodule LoboCatalogService do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(LoboCatalogService.Repo, []),
      # Start the endpoint when the application starts
      supervisor(LoboCatalogService.Endpoint, []),
      # Start your own worker by calling: LoboCatalogService.Worker.start_link(arg1, arg2, arg3)
      # worker(LoboCatalogService.Worker, [arg1, arg2, arg3]),
    ]
